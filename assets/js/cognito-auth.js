/*global MacroFade _config AmazonCognitoIdentity AWSCognito*/
...
(function scopeWrapper($) {
    ...
    MacroFade.signOut = function signOut() {
        userPool.getCurrentUser().signOut();
    };

    MacroFade.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
